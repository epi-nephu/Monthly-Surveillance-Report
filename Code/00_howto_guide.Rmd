...
You will not need to make any changes to the 01_data_prep_monthly.R script. The code will automatically do a check when you run it and will tell PHAR whether or not you are using the proxy server, pull the data from PHAR, do some data wrangling, and save the data extracts into the Data subfolder.
