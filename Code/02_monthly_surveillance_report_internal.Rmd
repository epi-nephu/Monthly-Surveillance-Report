---
title: 'NEPHU Monthly Surveillance Report - Internal - May 2026'
output: 
  html_document: 
    code_folding: none
    toc: true
    ...
    self_contained: true
knit: (function(input, ...) {
  rmarkdown::render(input, output_file = "Monthly Surveillance Report 2026 05 Internal", output_dir = "../Reports") })
---
