---
title: 'NEPHU Monthly Surveillance Report - Internal - December 2025'
output: 
  html_document: 
    code_folding: none
    toc: true
    ...
    self_contained: true
knit: (function(input, ...) {
  rmarkdown::render(input, output_file = "Monthly Surveillance Report 2025 12 Internal", output_dir = "../Reports") })
